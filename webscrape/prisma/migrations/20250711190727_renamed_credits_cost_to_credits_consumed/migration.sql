...
CREATE TABLE "new_ExecutionPhase" (
    ...
    CONSTRAINT "ExecutionPhase_workflowExecutionId_fkey" FOREIGN KEY ("workflowExecutionId") REFERENCES "WorkflowExectution" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
